...
if(session.getAttribute("Ausername")!=null){
	if(session.getAttribute("isAccountant").equals("yes")){
	...
	<div class="loginpage">
		<div class="formbody">
			...
			<hr />
			<form action="accountantloginverify" method="post">
				...
				<label for="userid">Enter UserName:</label><input type="text"
					id="userid" name="userid" placeholder="username" required autofocus />
				<label for="password">Enter password:</label><input type="password"
					id="password" name="password" placeholder="password" required /> <input
